...
var MyCardsPage = (function () {
    function MyCardsPage(backand, services, nav) {
    ...
    MyCardsPage.prototype.myCards = function () {
        var _this = this;
        var items = 'MyCard';
    ...
    MyCardsPage.prototype.goTo = function (id) {
        var item = {
            index: id,
            table: 'items'
        };
...
exports.MyCardsPage = MyCardsPage;
