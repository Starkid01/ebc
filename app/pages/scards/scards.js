...
var SCardsPage = (function () {
    function SCardsPage(backand, services, nav) {
    ...
    SCardsPage.prototype.goTo = function (id) {
        var item = {
            index: id,
            table: 'samples'
        };
...
exports.SCardsPage = SCardsPage;
//# sourceMappingURL=scards.js.map
