...
import { LocalStorage, Toast, Platform, Storage, ActionSheet, Events, App } from 'ionic-angular';
...
export class Services {
  ...
  constructor(public app:App, public backand:Backand, public http:Http, public events:Events) {
    this.http = http;
  }
